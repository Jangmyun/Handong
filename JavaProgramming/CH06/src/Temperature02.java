...
public class Temperature02 {
  ...
  Temperature02(double temp) {
    this(temp, 'C');
  }

  Temperature02(char deg) {
    this(0.0, deg);
  }

  Temperature02(double temp, char deg) {
  ...
  static Temperature02 convertDegree(Temperature02 t) {
    Temperature02 tmp = new Temperature02();
    if (t.degree == 'C') {
      tmp.degree = 'F';
  ...
  void writeC() {
    if (this.degree == 'C') {
      ...
      Temperature02 t = Temperature02.convertDegree(this);
      t.writeOutput();
    }
  }
